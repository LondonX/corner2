...
final class SwipeProgressBar {
	...
	private final static int COLOR1 = 0xFF3289d9;
	private final static int COLOR2 = 0xFF899a18;
	private final static int COLOR3 = 0xFFef9f40;
	private final static int COLOR4 = 0xFFe7528e;
	...
	void draw(Canvas canvas) {
		...
		if (mRunning || (mFinishTime > 0)) {
			...
			if (!mRunning) {
				...
				mClipRect.set(cx - clearRadius, marginTop, cx + clearRadius,
						height + marginTop);
